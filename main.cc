/*
  ...
  Name: Andrew Kinnear
  This program is used to add and multiply big numbers together,
  and handles decimals. Written in C++ and uses a CLI.
  Command line Use: a.out [add/mult] inFile1 inFile2 outFile
